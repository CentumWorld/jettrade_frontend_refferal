...
const UserDetails = () => {
  ...
  const fetchMemberProfilePhoto = async () => {
    ...
    try {
      const response = await axios.post(
        `${apiurl}` + "/member/fetch-member-profile-photo",
        data,
        config
      );
  ...
  const uploadMemberProfile = (event) => {
    ...
    axios
      .post(
        `${apiurl}` + "/member/member-profile-photo-upload",
        formData,
        config
      )
      .then((res) => {
  ...
  const editModalSubmit = (e) => {
    ...
    axios
      .post(
        `${apiurl}` + "/member/refferal/save-member-edited-details",
        data,
        config
      )
      .then((res) => {
              ...
              <div className="row">
                <div className="row_content">
                  ...
                  <div className="">
                    ...
                    <span>
                      <NavLink to={""}>Get Verified</NavLink>
                    </span>
                  </div>
                </div>
              </div>
              ...
              <Row style={{ marginBottom: "5px" }}>
                ...
                <Col span={12}>
                  <DatePicker
                    name="dob"
                    value={
                      editMemberData.dob ? moment(editMemberData.dob) : null
                    }
